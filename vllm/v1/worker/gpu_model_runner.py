...
class GPUModelRunner(
    ...
    def _execute_model_impl(
            ...
            with self.synchronize_input_prep():
                ...
                if not num_scheduled_tokens:
                    ...
                    if not has_kv_transfer_group() \
                        or scheduler_output.is_empty_execution:
        ...
        with (
            set_forward_context(
                ...
                ubatch_slices=ubatch_slices,
                virtual_runner=self.runner_id,
                preempted_signal=self.preempted_signal,
                execution_signal=self.execution_signal,
                ckpt_epochs=self.ckpt_epochs,
                nccl_lock=self.nccl_lock,
                sync_ckpt=self.sync_ckpt,
                tp_signal=self.tp_signal,
        ...
        grammar_output = scheduler_output.grammar_output
        ...
        with record_function_or_nullcontext(
            ...
            async_output = AsyncGPUModelRunnerOutput(
                ...
                default_stream=self.compute_stream,
            )
        with record_function_or_nullcontext(
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        skip_kv_init = self.vllm_config.skip_kv_init if \
            hasattr(self.vllm_config, "skip_kv_init") else False
        if not skip_kv_init:
        ...
        if has_kv_transfer_group() and not skip_kv_init:
